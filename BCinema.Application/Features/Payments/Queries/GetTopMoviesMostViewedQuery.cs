...
public class GetTopMoviesMostViewedQuery : IRequest<IEnumerable<MovieDto>>
{
    ...
    public class GetTopMoviesMostViewedQueryHandler : IRequestHandler<GetTopMoviesMostViewedQuery, IEnumerable<MovieDto>>
    {
        private readonly IPaymentRepository paymentRepository;
        private readonly IMovieFetchService movieFetchService;

        public GetTopMoviesMostViewedQueryHandler(IPaymentRepository paymentRepository, IMovieFetchService movieFetchService)
        {
