...
namespace BCinema.Application.Features.Schedules.Validator
{
    public class UpdateScheduleValidator : AbstractValidator<UpdateScheduleCommand>
    {
        ...
        public UpdateScheduleValidator(IApplicationDbContext context)
        {
            _context = context;
        ...
        private async Task<bool> NoOverLappingSchedule(UpdateScheduleCommand command, DateTime date, CancellationToken cancellationToken)
        {
        ...
        private async Task<bool> ReleaseDateBeforeSchedule(UpdateScheduleCommand command, DateTime date, CancellationToken cancellationToken)
        {
