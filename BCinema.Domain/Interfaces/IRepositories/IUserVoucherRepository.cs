...
namespace BCinema.Domain.Interfaces.IRepositories
{
    public interface IUserVoucherRepository
    {
        ...
        Task<UserVoucher?> GetUserVoucherByUIdAndVIdAsync(Guid userId, Guid voucherId, CancellationToken cancellationToken);
        Task<UserVoucher?> GetUserVoucherByUIdAndVCodeAsync(Guid userId, string code, CancellationToken cancellationToken);
